...
public partial class ScreenshotSettingsModel : ObservableObject
{
    ...
    private bool _enableWebcamDebug = false;
    [JsonPropertyName("enableWebcamDebug")]
    public bool EnableWebcamDebug 
    {
        get => _enableWebcamDebug;
        set => SetProperty(ref _enableWebcamDebug, value);
    }
