...
public partial class SidebarViewModel : ViewModelBase
    ...
    public ObservableCollection<MenuItemViewModel> BottomMenuItems { get; } = new ObservableCollection<MenuItemViewModel>();
    ...
    private string _currentTarget = string.Empty;
        ...
        public SidebarViewModel()
        {
            ...
            _sidebarWidth = IsExpanded ? 220 : 50;
    ...
    public void RefreshMenuItems()
    {
        ...
        BottomMenuItems.Add(new MenuItemViewModel(LocalizationService.Instance.GetString("Sidebar_Settings"), "fa-cog", NavigateCommand, "Settings"));
        BottomMenuItems.Add(new MenuItemViewModel(LocalizationService.Instance.GetString("Sidebar_About"), "fa-info-circle", NavigateCommand, "About"));
        
        // 恢复选中态
        UpdateSelectedItem(currentTarget);
    }

    public void UpdateSelectedItem(string target)
    {
